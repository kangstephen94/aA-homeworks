    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          { 'class': 'active', exact: true, to: '/red' },
          'Red'
        ),
        _react2.default.createElement(
          _reactRouterDom.NavLink,
          { 'class': 'active', to: '/red/orange' },
          'Add orange'
        ),
        _react2.default.createElement(
          _reactRouterDom.NavLink,
          { 'class': 'active', to: '/red/yellow' },
          'Add yellow'
        ),
        _react2.default.createElement(
          _reactRouterDom.NavLink,
          { 'class': 'active', to: '/green' },
          'Green'
        ),
        _react2.default.createElement(
          _reactRouterDom.NavLink,
          { 'class': 'active', exact: true, to: '/blue' },
          'Blue only'
        ),
        _react2.default.createElement(
          _reactRouterDom.NavLink,
          { 'class': 'active', to: '/blue/indigo' },
          'Add indigo'
        ),
        _react2.default.createElement(
          _reactRouterDom.NavLink,
          { 'class': 'active', to: '/violet' },
          'Violet'
        ),
        _react2.default.createElement(
          'div',
